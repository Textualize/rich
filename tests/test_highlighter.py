...
highlight_tests = [
    ...
    (
        ...
        [
            Span(0, 1, "repr.tag_start"),
            Span(1, 5, "repr.tag_name"),
            Span(5, 14, "repr.tag_contents"),
            Span(14, 15, "repr.tag_end"),
    ...
    (
        ...
        [
            ...
            Span(31, 32, "repr.tag_start"),
            Span(32, 37, "repr.tag_name"),
            Span(37, 43, "repr.tag_contents"),
            Span(43, 44, "repr.tag_end"),
            Span(0, 1, "repr.brace"),
            Span(44, 45, "repr.brace"),
            Span(8, 13, "repr.str"),
            Span(23, 28, "repr.str"),
            Span(38, 43, "repr.str"),
        ],
