...
def test_task_progress_column_speed() -> None:
    ...
    speed_text = TaskProgressColumn.render_speed(5, units="Hz")
    assert speed_text.plain == "5.0 Hz"

    speed_text = TaskProgressColumn.render_speed(5000, units="Hz")
    assert speed_text.plain == "5.0×10³ Hz"

    speed_text = TaskProgressColumn.render_speed(8888888, units="Hz")
    assert speed_text.plain == "8.9×10⁶ Hz"
